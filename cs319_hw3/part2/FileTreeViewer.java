...
public class FileTreeViewer extends JPanel
{
  ...
  /**
   * Creates the viewer.  This constructor is appropriate
   * for use in both applets and applications.
   * @param host
   *   the hostname for the server to which this viewer
   *   connects
   *   
   */
  ...
  /**
   * Creates a FileTreeViewer in a frame and displays it, using
   * the default hostname and port.
   * @param root
  ...
  /**
   * Expansion listener initiates update of a directory
   * node when expanded.
   */
  ...
  /**
   * Selection listener enables appropriate buttons
   * depending on whether a file or directory is 
   * selected.
   */
  ...
  /**
   * Button listener initiates upload, download, or
   * directory refresh.
   */
