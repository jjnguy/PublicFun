...
/**
 * Class to be used as tree node for representing a 
 * file tree in a Swing application.
 */
public class FileNode
{
  ...
  /**
   * Indicates whether the children of this node have ever 
   * been created.
   */
   ...
   * @return
   *   child at the given position, or null if there
   *   is no child at the given position
   */
   ...
   * @return
   *   the filename represented by this node
   */
  ...
  /**
   * Determines whether this node represents a 
   * directory.
   * @return
   *   true if this node represents a directory, false
   *   otherwise
   */
  ...
  /**
   * Create the child nodes for this node, if necessary.  
   * If the <code>forceRefresh</code> parameter is true, recreates
   * the child nodes whether or not they have been created before.
   * 
   * @param forceRefresh indicates whether to recreate the child nodes
