...
public class SaveSong {
	...
	public SaveSong(InputStream fileStream) throws IOException {
		...
		if (!song.createNewFile()) {
			System.err
					.println("Could not create song, location already exists, this is a bug");
			return;
		}
	...
	/**
	 * 
	 * @return String containing path to saved mp3 file. String will be null if mp3 was not
	 *         saved in constructor
	 */
