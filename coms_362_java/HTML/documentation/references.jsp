...
<%@page import="webInterface.HTMLFooter"%><html>
	...
	<body>
		<div class="finalPaperFull plainText" >
			<h1>Dependencies</h1>
			<div class="overview">
			...
			<div class="overview">
				...
				<a href="http://stackoverflow.com">StackOverflow.com</a><br class="noPad"/>
				...
				<h2>Mp3 Tunes</h2>
				<a href="http://mp3tunes.com/">Mp3Tunes.com</a><br class="noPad"/>
