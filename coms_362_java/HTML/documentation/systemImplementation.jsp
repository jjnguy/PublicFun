	...
	<body>
		<div class="finalPaperFull">
			...
			<div class="overview">
				...
				section will detail what these technologies are and how they are used in our project.</p>
			</div>
			<h3>View</h3>
			<div class="overview">
				...
				snippet of Javascript code to allow users to stream songs from the jTunes server, as well as validate user forms.</p>
			</div>
			<h3>Model</h3>
			<div class="overview">
