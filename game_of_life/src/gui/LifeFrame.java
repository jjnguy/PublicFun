...
/**
 * This class is in charge of managing a LifeDisplay. It animates it and lets the user interact with the board.
 * 
 * @author Justin
 * 
 */
   ...
   private final JPanel buildControlPanel() {
      ...
      load.addActionListener(new ActionListener() {
         ...
         public void actionPerformed(ActionEvent e) {
            ...
            if (choice == JFileChooser.APPROVE_OPTION) {
               try {
                  LifeBoard board = LifeBoardSaveAndLoad.load(chooser.getSelectedFile().getAbsolutePath());
